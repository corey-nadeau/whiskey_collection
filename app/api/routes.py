...
def create_whiskey(current_user_token):
    ...
    whiskey = Whiskey(maker, flavor, year, rating, user_token= user_token)
...
def update_whiskey(current_user_token, id):
    ...
    whiskeys.maker = request.json["maker"]
    whiskeys.flavor = request.json['flavor']
    whiskeys.year = request.json['year']
    whiskeys.rating = request.json['rating']
    whiskeys.user_token = current_user_token.token
